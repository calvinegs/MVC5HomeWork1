namespace MVC5HomeWork1.Models
{
	public static class RepositoryHelper
	{
		...
		public static 客戶統計資料Repository Get客戶統計資料Repository()
		{
			var repository = new 客戶統計資料Repository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static 客戶統計資料Repository Get客戶統計資料Repository(IUnitOfWork unitOfWork)
		{
			var repository = new 客戶統計資料Repository();
			repository.UnitOfWork = unitOfWork;
			return repository;
